import type IEIP712Data from '../../interfaces/ieip712data.ts';
...
const ServiceTerm: IEIP712Data = {
  ...
  */
    ...
    content: 'You are going to use MerMer-Official and agree every rules in TideBit',
    from: '0xCAFECAAd15f96E1EfcD846e1ae27115645C6D606',
    to: 'MerMer-Official',
    */
    domain: 'https://MerMer-Official.com',
    agree: [
      'https://MerMer-Official.com/term_of_service/{hash}',
      'https://MerMer-Official.com/private_policy/{hash}',
    ],
