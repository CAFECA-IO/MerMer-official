...
export const jobList = [
  {
    jobTitle: 'HIRING_PAGE.JOB_1_NAME',
    details: [
    ...
    descriptions: [
      'HIRING_PAGE.JOB_1_DESCRIPTION_1',
      'HIRING_PAGE.JOB_1_DESCRIPTION_2',
      'HIRING_PAGE.JOB_1_DESCRIPTION_3',
      'HIRING_PAGE.JOB_1_DESCRIPTION_4',
      'HIRING_PAGE.JOB_1_DESCRIPTION_5',
      'HIRING_PAGE.JOB_1_DESCRIPTION_6',
      'HIRING_PAGE.JOB_1_DESCRIPTION_7',
      'HIRING_PAGE.JOB_1_DESCRIPTION_8',
    ],
    requirements: [
      'HIRING_PAGE.JOB_1_REQUIREMENT_1',
      'HIRING_PAGE.JOB_1_REQUIREMENT_2',
      'HIRING_PAGE.JOB_1_REQUIREMENT_3',
      'HIRING_PAGE.JOB_1_REQUIREMENT_4',
      'HIRING_PAGE.JOB_1_REQUIREMENT_5',
      'HIRING_PAGE.JOB_1_REQUIREMENT_6',
      'HIRING_PAGE.JOB_1_REQUIREMENT_7',
    ],
  },
  {
    jobTitle: 'HIRING_PAGE.JOB_2_NAME',
    details: [
      'HIRING_PAGE.JOB_DETAIL_FULL_TIME',
      'HIRING_PAGE.JOB_DETAIL_SALARY_1',
      'HIRING_PAGE.JOB_DETAIL_LOCATION_1',
    ...
    requirements: [
      'HIRING_PAGE.JOB_2_REQUIREMENT_1',
      'HIRING_PAGE.JOB_2_REQUIREMENT_2',
      'HIRING_PAGE.JOB_2_REQUIREMENT_3',
      'HIRING_PAGE.JOB_2_REQUIREMENT_4',
      'HIRING_PAGE.JOB_1_REQUIREMENT_4',
      'HIRING_PAGE.JOB_1_REQUIREMENT_5',
      'HIRING_PAGE.JOB_1_REQUIREMENT_6',
      'HIRING_PAGE.JOB_1_REQUIREMENT_7',
