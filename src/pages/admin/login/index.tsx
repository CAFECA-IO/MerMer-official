    ...
    <>
      ...
      <div className='flex h-screen flex-row items-center'>
        <div
          ...
          style={{ width: 'calc(100vw - 717px)' }}
        >
          <div className='m-20 flex flex-col justify-between gap-12'>
            <div className='font-Dosis text-7xl font-bold'>
              <h1>Welcom to</h1>
              <h1><span className='text-lightBlue1'>MerMer </span>Team</h1>
            </div>
            <MerMerButton className='flex flex-row gap-2 px-10 py-[10px]' onClick={globalCtx.visibleSignatureProcessModalHandler}>
              <Image 
                className=''
                src="/icons/login.svg"
                width={24}
