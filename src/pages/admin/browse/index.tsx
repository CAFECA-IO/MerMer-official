    ...
    <>
      ...
      <Layout>
        <div className="flex w-500px flex-col gap-6 px-10 py-6 font-Dosis md:w-640px lg:w-[768px] xl:w-[1024px]">
          ...
          <KmCardDisplay
            kmCards={renderedKmMeta}
            cardsRenderPerPage={cardsRenderPerPage}
          ...
          <Pagination
            ...
            totalPages={Math.ceil(renderedKmMeta.length / cardsRenderPerPage)}
          ></Pagination>
        </div>
      </Layout>
    </>
...
export const getServerSideProps: GetServerSideProps = async context => {
  ...
  const protocol = context.req.headers['x-forwarded-proto'] ? 'https' : 'http';
